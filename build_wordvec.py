...
morph_embeddings = model.add_lookup_parameters((63460 + 1, int(200 / 4)))  # randomly initialized

# input dim (morpheme embedding dimension): 200/4, output dimension: 300
fwdLSTM = dy.LSTMBuilder(1, int(200 / 4), 200, model)
bwdLSTM = dy.LSTMBuilder(1, int(200 / 4), 200, model)
